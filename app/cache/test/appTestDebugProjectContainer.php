...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:\\xampp\\htdocs\\jobeet\\app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a98a05c13ae9126e225cc57a587f69c0');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a98a05c13ae9126e225cc57a587f69c0');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a98a05c13ae9126e225cc57a587f69c0');

        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => 'C:\\xampp\\htdocs\\jobeet\\src\\Ens\\JobeetBundle\\Resources\\config\\doctrine'));
        $d->setNamespacePrefixes(array('C:\\xampp\\htdocs\\jobeet\\src\\Ens\\JobeetBundle\\Resources\\config\\doctrine' => 'Ens\\JobeetBundle\\Entity'));
        ...
        $f->setProxyDir('C:\\xampp\\htdocs\\jobeet\\app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:\\xampp\\htdocs\\jobeet\\app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:\\xampp\\htdocs\\jobeet\\app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\xampp\\htdocs\\jobeet\\app/cache/test/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:\\xampp\\htdocs\\jobeet\\app');
    }
    ...
    {
        return $this->services['session.storage'] = new \Symfony\Component\HttpFoundation\SessionStorage\FilesystemSessionStorage('C:\\xampp\\htdocs\\jobeet\\app/cache/test/sessions', array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:\\xampp\\htdocs\\jobeet\\app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/twig', 'charset' => 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\jobeet\\vendor\\symfony\\src\\Symfony\\Bundle\\TwigBundle\\DependencyInjection/../../../Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'C:\\xampp\\htdocs\\jobeet\\app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\xampp\\htdocs\\jobeet\\app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\xampp\\htdocs\\jobeet\\app/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\jobeet\\app',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test',
            'kernel.logs_dir' => 'C:\\xampp\\htdocs\\jobeet\\app/logs',
            ...
            'debug.container.dump' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\jobeet\\vendor\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => 'C:\\xampp\\htdocs\\jobeet\\src\\Ens\\JobeetBundle\\Resources\\config\\validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\xampp\\htdocs\\jobeet\\app/cache/test/profiler.db',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\jobeet\\app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\jobeet\\app/cache/test/assetic',
            ...
            'assetic.read_from' => 'C:\\xampp\\htdocs\\jobeet\\app/../web',
            'assetic.write_to' => 'C:\\xampp\\htdocs\\jobeet\\app/../web',
